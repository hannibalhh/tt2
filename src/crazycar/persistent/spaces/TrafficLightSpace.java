...
public class TrafficLightSpace {
    ...
    public void setLightNS(String str){
    	...
    	else this.stateNS=TrafficLight.Color.GREEN;
    }
    ...
    public void setLightEW(String str){
    	...
    	else this.stateEW=TrafficLight.Color.GREEN;
    }
	...
	public String toString() {
		return "TrafficLightSpace[lightNS=" + (stateNS.equals(TrafficLight.Color.GREEN)?" GREEN ":" RED ") + ", lightEW= "+ (stateEW.equals(TrafficLight.Color.GREEN)?" GREEN ":" RED ") + location.toString() + "]";
	}
